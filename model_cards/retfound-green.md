...
|---|---|---|---|---|---|
| `retfound-green-v0.1` / v0.1 | CFP | [github_release](https://github.com/justinengelmann/RETFound_Green/releases/tag/v0.1) | 登记为开放 | 待核验 | 未验证 |
...
| 核验项 | 状态 | 证据/记录 | 最近核验 |
|---|---|---|---|
| 论文 | 待核验 | https://www.nature.com/articles/s41467-025-62123-z | 尚未登记 |
| 官方代码 | 待核验 | https://github.com/justinengelmann/RETFound_Green | 尚未登记 |
